...
1. Add relevant lints (e.g., `#![deny(missing_docs)]`) to the crate; some lints are already inherited from the workspace and do not need to be added to the new crate.
