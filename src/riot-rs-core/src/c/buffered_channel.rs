//! buffered multi producer multi receiver channel
//!
//! This quite complex, but needs to match RIOT-c's semantics.
//! In particular, the queue array can be changed at any time from the C API.
